...
```
cd existing_repo
git remote add origin https://gitlab.com/Verenasworld/baduiproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Verenasworld/baduiproject/-/settings/integrations)
